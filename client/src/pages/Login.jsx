...
const Login = () => {
  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-slate-100 p-4 font-sans selection:bg-indigo-600 selection:text-white">
      <div className="w-full max-w-md space-y-6">
        {/* Brand Header */}
        <div className="text-center space-y-2">
          <div className="inline-flex h-12 w-12 items-center justify-center rounded-2xl bg-indigo-600 text-white shadow-lg">
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full rounded-xl border border-slate-200 bg-slate-50 pl-10 pr-4 py-2.5 text-xs text-slate-900 placeholder-slate-400 focus:border-indigo-600 focus:bg-white focus:outline-none transition-all"
                />
              </div>
            </div>
          ...
          <div className="border-t border-slate-100 pt-6 space-y-3">
            ...
            <div className="grid grid-cols-3 gap-2 text-[10px]">
              <button
                ...
                className="rounded-xl border border-purple-200 bg-purple-50 p-2 text-purple-700 font-extrabold hover:bg-purple-100 transition-all text-center"
              >
                HR Admin
              </button>
              <button
                ...
                className="rounded-xl border border-blue-200 bg-blue-50 p-2 text-blue-700 font-extrabold hover:bg-blue-100 transition-all text-center"
              >
                Manager
              </button>
              <button
                ...
                className="rounded-xl border border-indigo-200 bg-indigo-50 p-2 text-indigo-700 font-extrabold hover:bg-indigo-100 transition-all text-center"
              >
                Employee
              </button>
            </div>
